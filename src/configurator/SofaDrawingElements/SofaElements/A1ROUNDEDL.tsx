    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.lineTo(shapeWidth * ANGLE_RADIUS, 0)
          ctx.quadraticCurveTo(0, 0, 0, shapeHeight * ANGLE_RADIUS)
          ctx.lineTo(0, shapeHeight * 0.8)
          ctx.lineTo(shapeArmrestWidth, shapeHeight * 0.8)
          ctx.lineTo(
            shapeArmrestWidth,
          ...
          ctx.quadraticCurveTo(
            shapeArmrestWidth,
            shapeBackrestWidth,
            shapeArmrestWidth + shapeArmrestWidth * 0.5,
            shapeBackrestWidth,
          )
