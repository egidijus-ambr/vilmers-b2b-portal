    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.moveTo(widthWithoutArmrest / 3, 0)
          ctx.lineTo(widthWithoutArmrest / 3, shapeHeight)
          ctx.moveTo((widthWithoutArmrest / 3) * 2, 0)
          ctx.lineTo((widthWithoutArmrest / 3) * 2, shapeHeight)
