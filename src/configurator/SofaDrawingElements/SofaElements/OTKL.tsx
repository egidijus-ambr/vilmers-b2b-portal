...
const OTKL = ({
  ...
  const dimension = getDimensions({ shapeWidth, shapeHeight, angle: rotation })
  const connectors = dimension.connectors
  ...
  return (
    <Group
      ...
      rotation={rotation}
      armrestPosition={dimension.armrestPosition}
    >
      {verticalMetric && (
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.moveTo(
            shapeArmrestWidth + SHADOW_WIDTH + 1,
