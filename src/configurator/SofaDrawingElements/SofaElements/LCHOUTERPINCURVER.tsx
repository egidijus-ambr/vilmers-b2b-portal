...
const LCHOUTERPINCURVER = ({
  ...
  const connectors = dimenstions.connectors
  const armrestPosition = dimenstions.armrestPosition
  ...
  return (
    <Group
      ...
      rotation={rotation}
      armrestPosition={armrestPosition}
    >
      {verticalMetric && (
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.moveTo(shapeWidth - shapeArmrestWidth, shapeBackrestWidth)
          ctx.lineTo(0, shapeBackrestWidth)
          ctx.lineTo(0, shapeHeight - shapeHeight * LCH_INCURVE_PERCENTAGE)

          ctx.quadraticCurveTo(
            (shapeWidth - shapeArmrestWidth) * LCH_INCURVE_PERCENTAGE * 2,
            shapeHeight - shapeHeight * LCH_INCURVE_PERCENTAGE,

            (shapeWidth - shapeArmrestWidth) * LCH_INCURVE_PERCENTAGE * 2,
            shapeHeight,
          )

          ctx.lineTo(shapeWidth - shapeArmrestWidth, shapeHeight)
          ctx.lineTo(shapeWidth - shapeArmrestWidth, shapeBackrestWidth)
      ...
      {/* CENTER PILLOW */}
      <Line
        x={(shapeWidth - shapeArmrestWidth - pillowSize) / 2}
...
export default LCHOUTERPINCURVER
