      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          if (radius > 0) {
            ...
            ctx.rect(0, 0, shapeBackrestWidth, shapeHeight / 1.6)
          }
      ...
      {backrestWidth > 0 && (
        <Shape
          ...
          sceneFunc={(ctx, shape) => {
            ...
            // Draw shadow
            ctx.moveTo(
              0 + shapeBackrestWidth + SHADOW_WIDTH - 2,
              0 + SHADOW_WIDTH - 2
            )
            ctx.lineTo(
              0 + shapeBackrestWidth + SHADOW_WIDTH - 2,
            ...
            ctx.moveTo(0 + 2, shapeHeight / 1.6 + SHADOW_WIDTH)
            ctx.lineTo(
              0 + shapeBackrestWidth + 2,
              shapeHeight / 1.6 + SHADOW_WIDTH
            )
            ctx.fillStrokeShape(shape)
          }}
