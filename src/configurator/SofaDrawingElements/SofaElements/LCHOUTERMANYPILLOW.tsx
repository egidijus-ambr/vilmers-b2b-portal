...
export const getDefaultSettings = () => {
  return {
    ...
    changeableProperties: {
      ...
      size_of_pillow: true,
      backrest_type: true, // MECHANIC, ELECTRIC, FIXED
      corner_radius: true,
    },
  }
}
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          const radius = Math.min(
            cornerRadius,
            (shapeWidth - shapeArmrestWidth * 2) / 2,
            shapeHeight / 2,
          )
          ...
          if (radius > 0) {
            ...
            const mainY = 0
            const mainWidth = shapeWidth - shapeArmrestWidth * 2
...
export default LCHOUTERMANYPILLOW
