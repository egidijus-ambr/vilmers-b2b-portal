    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.moveTo(shapeArmrestWidth, shapeBackrestWidth)
          ...
          ctx.lineTo(shapeArmrestWidth, shapeHeight)
          ctx.lineTo(shapeArmrestWidth, shapeBackrestWidth)
      ...
      <Line
        x={
          shapeArmrestWidth + (shapeWidth - shapeArmrestWidth - pillowSize) / 2
        }
...
export default LCHOUTERPINCURVEL
