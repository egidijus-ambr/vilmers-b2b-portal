...
const POLYGONLCHMANYPILLOWR = ({
  ...
  const shapeWidthModified = shapeWidth - shapeArmrestWidth //Modiy to subtract armrest
  ...
  useEffect(() => {
    const points = [
      shapeArmrestWidth + backPillowSize / 2,
      ...
      shapeWidth - shapeBackrestWidth - backPillowSize / 10,
    ...
    for (let i = 0; i < interpolatedPoints.length - 1; i++) {
      const p1 = interpolatedPoints[i] as any
      const p2 = interpolatedPoints[i + 1] as any
  ...
  return (
    ...
    >
      ...
      <Shape
        ...
        x={shapeArmrestWidth + shapeWidth / 2 + shapeOffsetFix}
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.lineTo(
            shapeWidthModified * (1 - POLYGON_LCH_CUT_PERCENTAGE) -
              shapeBackrestWidth / 2,
            shapeBackrestWidth,
          )
          ctx.lineTo(
            shapeWidthModified - shapeBackrestWidth,
            shapeHeight * POLYGON_LCH_CUT_PERCENTAGE + shapeBackrestWidth / 2,
          )
          ctx.lineTo(shapeWidthModified - shapeBackrestWidth, shapeHeight)

          // Rectangle itself
          ctx.moveTo(0, 0)
          ctx.lineTo(shapeWidthModified * (1 - POLYGON_LCH_CUT_PERCENTAGE), 0)
          ctx.lineTo(
            shapeWidthModified,
            shapeHeight * POLYGON_LCH_CUT_PERCENTAGE,
          )
          ctx.lineTo(shapeWidthModified, shapeHeight)
          ctx.lineTo(shapeWidthModified * POLYGON_ANGLE, shapeHeight)
          ctx.lineTo(0, shapeHeight * (1 - POLYGON_ANGLE))
          ctx.lineTo(0, 0)

          // Lines in middle of BACKREST
          ctx.moveTo(shapeWidthModified * (1 - POLYGON_LCH_CUT_PERCENTAGE), 0)
          ctx.lineTo(
            shapeWidthModified * (1 - POLYGON_LCH_CUT_PERCENTAGE) -
              shapeBackrestWidth / 2,
            shapeBackrestWidth,
      ...
      <Rect // armrest
        ...
        height={shapeHeight - shapeHeight * POLYGON_LCH_CUT_PERCENTAGE}
        ...
        <Line
          ...
          points={[
            ...
            shapeArmrestWidth +
              ...
              backPillowSize / 2,
            0 + shapeBackrestWidth + backPillowSize / 2,
...
export default POLYGONLCHMANYPILLOWR
