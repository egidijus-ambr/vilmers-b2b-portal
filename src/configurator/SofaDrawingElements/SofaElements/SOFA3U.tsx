    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.moveTo(shapeWidth / 3 + shapeArmrestWidth / 4, 0)
          ctx.lineTo(shapeWidth / 3 + shapeArmrestWidth / 4, shapeBackrestWidth)

          ctx.moveTo(shapeWidth - shapeWidth / 3 - shapeArmrestWidth / 4, 0)
          ctx.lineTo(
            shapeWidth - shapeWidth / 3 - shapeArmrestWidth / 4,
            shapeBackrestWidth,
          )
