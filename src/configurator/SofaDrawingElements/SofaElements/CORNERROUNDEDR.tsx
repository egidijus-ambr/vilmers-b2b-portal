    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ctx.beginPath()
          ctx.moveTo(0, 0)
          ctx.lineTo(shapeWidth * (1 - ANGLE_RADIUS), 0)
          ...
          // ctx.moveTo(6, 6)
          ctx.moveTo(
            shapeWidth - shapeBackrestWidth * ANGLE_RADIUS,
            shapeBackrestWidth * ANGLE_RADIUS,
          )
          ctx.lineTo(shapeWidth - shapeBackrestWidth, shapeBackrestWidth)
