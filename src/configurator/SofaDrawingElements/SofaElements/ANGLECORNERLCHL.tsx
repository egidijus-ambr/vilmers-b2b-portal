...
export const getConnectors = ({ shapeWidth, shapeHeight, angle }) => {
  return [
    {
      type: 'right',
      x: shapeWidth,
...
const ANGLECORNERLCHL = ({
  ...
  return (
    ...
    >
      ...
      {/* BACKREST PILLOWS */}
      <Group scaleX={-1} offsetX={shapeWidth}>
...
export default ANGLECORNERLCHL
