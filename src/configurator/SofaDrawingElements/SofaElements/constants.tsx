...
//--- PILLOWS
export const STANDART_PILLOW_SIZE = 40
export const BACKREST_PILLOW_SIZE = 50

export const PILLOW_FILL_COLOR = '#ddd';
export const PILLOW_STROKE_COLOR = 'black';
export const PILLOW_STROKE_WIDTH = 1;
export const PILLOW_OPACITY = 1;
