    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.lineTo(
            shapeWidth * (1 - POLYGON_CUT_PERCENTAGE) - shapeBackrestWidth / 2,
            shapeBackrestWidth,
          )
          ctx.lineTo(
          ...
          // Rectangle itself
          ctx.moveTo(0, 0)
          ctx.lineTo(shapeWidth * (1 - POLYGON_CUT_PERCENTAGE), 0)
          ctx.lineTo(shapeWidth, shapeHeight * POLYGON_CUT_PERCENTAGE)
          ctx.lineTo(shapeWidth, shapeHeight)
          ctx.lineTo(shapeWidth * POLYGON_ANGLE, shapeHeight)
