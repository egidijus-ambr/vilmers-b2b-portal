...
const ANGLECORNERLCHMANYPILLOWR = ({
  id,
  width,
  height,
  x,
  ...
  let marginForPillows =
    armSideBackPillowNumber < connectionPartSideBackPillowNumber ? 10 : 0
  //------
  ...
  return (
    <Group
      ...
      width={groupWidth}
      height={groupHeight}
      type="ANGLECORNERLCHMANYPILLOWR"
      x={xOffset}
      y={yOffset}
      originalWidth={width}
    ...
    >
      ...
      <Group
        id={id + 123123}
        x={singleShapeWidth}
        // y={shapeArmrestWidth * Math.tan(angleT)}
        rotation={connectionAngle}
      >
        {/* BAKCREST PILLOW 1 */}
        {Array.from(
...
export default ANGLECORNERLCHMANYPILLOWR
