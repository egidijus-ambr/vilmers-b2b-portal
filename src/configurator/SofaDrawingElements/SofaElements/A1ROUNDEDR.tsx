    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          ctx.beginPath()
          ctx.moveTo(0, 0)
          ctx.lineTo(shapeWidth - shapeWidth * ANGLE_RADIUS, 0)
          ctx.quadraticCurveTo(
            shapeWidth,
            0,
            shapeWidth,
            shapeHeight * ANGLE_RADIUS,
          )
          ctx.lineTo(shapeWidth, shapeHeight * 0.8)
          ctx.lineTo(shapeWidth - shapeArmrestWidth, shapeHeight * 0.8)
          ctx.lineTo(
            shapeWidth - shapeArmrestWidth,
            shapeBackrestWidth + shapeBackrestWidth * 0.5,
          )
          ctx.quadraticCurveTo(
            shapeWidth - shapeArmrestWidth,
            shapeBackrestWidth,
            shapeWidth - (shapeArmrestWidth + shapeArmrestWidth * 0.5),
            shapeBackrestWidth,
          )
