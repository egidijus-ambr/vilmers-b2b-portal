...
const A1PLEGAL = ({
  ...
  const shapeSeatHeight = seatHeight ?? SEAT_HEIGHT
  ...
  return (
    ...
    >
      ...
      <ArrowComponent
        x={shapeArmrestWidth + (shapeWidth - shapeArmrestWidth) / 2}
        y={shapeHeight + 2 + shapeSeatHeight / 2}
      />
