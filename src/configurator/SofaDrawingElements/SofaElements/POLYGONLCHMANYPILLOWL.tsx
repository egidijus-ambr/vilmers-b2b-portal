...
const POLYGONLCHMANYPILLOWL = ({
  ...
  useEffect(() => {
    const points = [
      ...
      shapeWidth - backPillowSize / 5 - shapeArmrestWidth,
      backrestWidth + backPillowSize / 5,
    ]
    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          // --- Lines for backrest
          ctx.moveTo(shapeWidthModified, shapeBackrestWidth)
          ctx.lineTo(
            shapeWidthModified -
          ...
          // Rectangle itself
          ctx.moveTo(shapeWidthModified, 0)
          ctx.lineTo(
            shapeWidthModified -
              shapeWidthModified * (1 - POLYGON_LCH_CUT_PERCENTAGE),
            0,
          ...
          ctx.lineTo(shapeWidthModified * (1 - POLYGON_ANGLE), shapeHeight)
          ctx.lineTo(shapeWidthModified, shapeHeight * (1 - POLYGON_ANGLE))
          ctx.lineTo(shapeWidthModified, 0)
      ...
      <Rect // armrest
        x={shapeWidth - shapeArmrestWidth}
        // y={rotatedHeight}
...
export default POLYGONLCHMANYPILLOWL
