    ...
    >
      ...
      <Shape
        ...
        sceneFunc={(ctx, shape) => {
          ...
          const widthWithoutArmrest = shapeWidth - shapeArmrestWidth
          ctx.moveTo(widthWithoutArmrest / 3 + shapeArmrestWidth, 0)
          ctx.lineTo(widthWithoutArmrest / 3 + shapeArmrestWidth, shapeHeight)
          ctx.moveTo((widthWithoutArmrest / 3) * 2 + shapeArmrestWidth, 0)
          ctx.lineTo(
            (widthWithoutArmrest / 3) * 2 + shapeArmrestWidth,
            shapeHeight,
          )
      ...
      <Line
        x={
          ...
          ((shapeWidth - shapeArmrestWidth) / 3 - pillowSize) / 2
        }
