...
// TEMPORARY test route to visually verify the `scroll_rhythm` gallery's
// Custom Styles `maxHeight` "stage height" behavior. Delete after screenshotting.
...
const data: ContentBlockData = {
  id: "temp-gallery-block-maxheight",
  type: "gallery",
  style: "scroll_rhythm",
  video_link: null,
  video_type: null,
  ...
  link_new_tab: null,
  link_page: null,
  extra_css: { maxHeight: 400 },
  config: null,
}

export default function TempGalleryMaxHeightPage() {
  return (
    <div className="py-10">
